export type Restaurant = {
  ...
  mealPeriod: 'Breakfast' | 'Lunch' | 'Dinner' | 'All Day' | 'Breakfast, Dinner' | 'Lunch, Dinner';
...
export const moonPalaceRestaurants: Restaurant[] = [
  // 🌅 SUNRISE
 {
  id: 'sun-01',
  name: 'Gondola',
  description: 'Italian cuisine with breakfast buffet and à la carte dinner. Stunning stained glass ceiling.',
...
},
{
  id: 'sun-02',
  name: 'Momo',
  description: 'Asian cuisine with teppanyaki tables and à la carte sushi. Reservations required for teppanyaki.',
...
},
{
  id: 'sun-03',
  name: 'Bugambilias',
  description: 'Mexican dinner buffet and international buffet for breakfast and lunch. Known for pool views.',
...
},
{
  id: 'sun-04',
  name: 'Palapa Asadero',
  description: 'Grilled meats and international buffet by the pool. Great for families.',
...
},
{
  id: 'sun-05',
  name: 'Pier 8',
  description: 'Seafood restaurant with daytime poolside service and refined dinner options.',
...
},
{
  id: 'sun-07',
  name: 'Smoked',
  description: 'Texan-style BBQ restaurant next to the Flowrider. Great for quick bites.',
...
},
{
  id: 'sun-08',
  name: 'Agra',
  description: 'North Indian cuisine including curries, naan, and samosas. Very popular—book ahead.',
...
},
{
  id: 'sun-09',
  name: 'Bistro Café',
  description: '24-hour café with coffee, ice cream, paninis, and desserts. Top pick for snacks.',
...
},
{
  id: 'sun-10',
  name: 'Poolside Pizza',
  description: 'Wood-fired pizza station next to Los Columpios Bar. Convenient but varies in quality.',
